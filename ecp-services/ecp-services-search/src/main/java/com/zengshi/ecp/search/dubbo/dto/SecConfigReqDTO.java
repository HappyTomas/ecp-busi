...
public class SecConfigReqDTO extends BaseInfo {

    private static final long serialVersionUID = 1887941759312723322L;
    ...
    private List<SecObjectReqDTO> secObjectReqDTOList;
    ...
    public List<SecObjectReqDTO> getSecObjectReqDTOList() {
        return secObjectReqDTOList;
    }

    public void setSecObjectReqDTOList(List<SecObjectReqDTO> secObjectReqDTOList) {
        this.secObjectReqDTOList = secObjectReqDTOList;
    }
