...
public class DeltaIndexRunnable2 implements Runnable{
    
    private DeltaMessage message;
    
    public DeltaIndexRunnable2(DeltaMessage message){
    ...
    public void run() {
        ...
        if(StringUtils.isBlank(message.getObjectNameEn())){
                    ...
                    if (StringUtils.equalsIgnoreCase(secObjectRespDTO.getObjectNameen(),
                        ...
                        if (StringUtils.isNotBlank(inspectorName)) {
                            try {
                                ...
                                Class[] paramTypes = { SecObjectRespDTO.class, DeltaMessage.class };
                        ...
                        try {
                            ...
                            if (StringUtils.isBlank(handlerName)) {
                                ...
                                try {
                                    ...
                                    Class[] paramTypes = { SolrServer.class, SolrServer.class,SecConfigRespDTO.class,SecObjectRespDTO.class,DeltaMessage.class };
