...
public class SecConfigRespDTO extends BaseResponseDTO {
    ...
    private List<SecObjectRespDTO> secObjectRespDTOList;
    ...
    public List<SecObjectRespDTO> getSecObjectRespDTOList() {
        return secObjectRespDTOList;
    }

    public void setSecObjectRespDTOList(List<SecObjectRespDTO> secObjectRespDTOList) {
        this.secObjectRespDTOList = secObjectRespDTOList;
    }
