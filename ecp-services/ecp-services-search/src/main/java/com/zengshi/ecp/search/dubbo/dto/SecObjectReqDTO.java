...
public class SecObjectReqDTO extends BaseInfo {

    /** 
     * serialVersionUID:
     */ 
    private static final long serialVersionUID = 8916374518277936669L;
    ...
    private List<SecFieldReqDTO> secFieldReqDTOList;
    
    private List<Long> delFieldIds;
    ...
    public List<SecFieldReqDTO> getSecFieldReqDTOList() {
        return secFieldReqDTOList;
    }

    public void setSecFieldReqDTOList(List<SecFieldReqDTO> secFieldReqDTOList) {
        this.secFieldReqDTOList = secFieldReqDTOList;
    }

    public List<Long> getDelFieldIds() {
        return delFieldIds;
    }

    public void setDelFieldIds(List<Long> delFieldIds) {
        this.delFieldIds = delFieldIds;
    }
