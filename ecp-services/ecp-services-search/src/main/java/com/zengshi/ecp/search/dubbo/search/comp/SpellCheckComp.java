 ...
 * Description: 拼写检查接口<br>
 * Date:2015年8月17日下午3:28:57 <br>
 ...
 * @since JDK 1.6
 */
public class SpellCheckComp extends BaseComp {

    private final static String MODULE = "【搜索引擎】SpellCheckComp";
    
    private final static String TEXT="SpellCheck异常";
    ...
    public static SearchResult<CollationReuslt> spellcheck(SearchParam searchParam) {
        ...
        try {
            ...
            query.set(CommonParams.QT, ERequestType.SPELLCHECK.getHandler());
            ...
            searchResult = addReuslt(queryResp.getSpellCheckResponse(), searchResult);
    ...
    public static SearchResult<CollationReuslt> addReuslt(SpellCheckResponse spellCheckResponse,
        ...
        if (spellCheckResponse != null) {
            ...
            if (collatedList != null && !collatedList.isEmpty()) {

                List<CollationReuslt> collatedStrList = new ArrayList<CollationReuslt>();
                CollationReuslt collationReuslt = null;

                for (Collation collation : collatedList) {
                    collationReuslt = new CollationReuslt(collation.getCollationQueryString(),
                            collation.getNumberOfHits());
                    collatedStrList.add(collationReuslt);
                }

                searchResult.setResultList(collatedStrList);
            }
        }
