...
public class GoodSearchResult extends BaseResponseDTO {
    ...
    public String toString() {
        return "GoodSearchResult [id=" + id
                + ", mainPic=" + mainPic + ", mainPicIUrl=" + mainPicIUrl + ", defaultPrice="
                + defaultPrice + ", gdsName=" + gdsName + ", gdsSubHead=" + gdsSubHead
                + ", shopName=" + shopName + ", shopId=" + shopId + ", guidePrice=" + guidePrice
                + ", mainCategoryCode=" + mainCategoryCode + ", topCategoryCode=" + topCategoryCode
                + ", sales=" + sales + ", mainCategoryValue=" + mainCategoryValue
                + ", topCategoryValue=" + topCategoryValue + ", topCategoryCodeAndValue="
                + topCategoryCodeAndValue + ", mainCategoryCodeAndValue="
                + mainCategoryCodeAndValue + ", gdsTypeId=" + gdsTypeId + ", gdsDesc=" + gdsDesc
                + ", gdsTypeName=" + gdsTypeName + ", storage=" + storage + ", storageDesc=" + storageDesc + ", storageStatus="
                + storageStatus + ", updateTime=" + updateTime + ", uncertainfield_prop="
