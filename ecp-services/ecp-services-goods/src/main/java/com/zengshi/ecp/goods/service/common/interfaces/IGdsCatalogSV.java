 ...
 * @since JDK 1.6 
 */
public interface IGdsCatalogSV {
    ...
    */
     ...
     * 
     * @author liyong7
     * @param reqDTO reqDTO.CatalogCode必传.
     * @return 针对返回值需要进行null判断,该方法不会根据状态进行过滤,调用方需要根据业务需求需要针对返回的对象状态进行判断.
     * @throws BusinessException 
     * @since JDK 1.6
     */
    ...
    /**
     * 
     * queryDefaultGdsCatalog:查询默认目录. <br/> 
     * 
     * @author liyong7
     * @return
     * @throws BusinessException 
