...
public class GdsShop2CatgrateRespDTO extends BaseResponseDTO    {
    /** 
	 * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
	 * @since JDK 1.6 
	 */ 
	private static final long serialVersionUID = -8207336815518953322L;
    ...
    public String toString() {
        ...
        sb.append(", rateTimes=").append(rateTimes);
