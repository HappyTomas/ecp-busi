...
public class GdsCatgSyncRespDTO extends BaseResponseDTO {
    private Long id;
    ...
    public String getMapCatgName() {
        return mapCatgName;
    }

    public void setMapCatgName(String mapCatgName) {
        this.mapCatgName = mapCatgName;
    }

    public Boolean getIfLeafNode() {
        return ifLeafNode;
    }

    public void setIfLeafNode(Boolean ifLeafNode) {
        this.ifLeafNode = ifLeafNode;
    }
