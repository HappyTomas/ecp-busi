...
public class GdsAdaptRespDTO extends BaseResponseDTO    {
	
    /** 
	 * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
	 * @since JDK 1.6 
	 */ 
	private static final long serialVersionUID = -591991837420844370L;
    ...
    public void setAdaptStrategy(String adaptStrategy) {
        this.adaptStrategy = adaptStrategy == null ? null : adaptStrategy.trim();
    }
