...
public class GdsCatg2LabelRespDTO extends BaseResponseDTO {
    ...
    public GdsLabel getGdsLabel() {
        return gdsLabel;
    }

    public void setGdsLabel(GdsLabel gdsLabel) {
