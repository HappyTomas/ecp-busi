 ...
 */
public interface ICustServiceMgrSV {
	 ...
	 * @since JDK 1.6
	 */
	boolean isCustJoinIn(ImCustReqDTO dto) throws BusinessException;
	 ...
	 * @since JDK 1.6
	 */
	void rollInRollOut(ImCustReqDTO dto) throws BusinessException;
