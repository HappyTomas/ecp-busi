...
public class ReportItemReqDTO extends BaseInfo{
    ...
    private Timestamp calDateStart;
    
    private Timestamp calDateEnd;
	...
	public Timestamp getCalDateStart() {
		return calDateStart;
	}

	public void setCalDateStart(Timestamp calDateStart) {
		this.calDateStart = calDateStart;
	}

	public Timestamp getCalDateEnd() {
		return calDateEnd;
	}

	public void setCalDateEnd(Timestamp calDateEnd) {
