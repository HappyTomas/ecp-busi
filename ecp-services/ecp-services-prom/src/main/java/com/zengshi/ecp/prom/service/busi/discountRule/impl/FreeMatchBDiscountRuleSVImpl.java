 ...
 * @author huangjx
 */
public class FreeMatchBDiscountRuleSVImpl extends DefaultPromDiscountRuleSVImpl{

    private static final String MODULE = FreeMatchBDiscountRuleSVImpl.class.getName();
    ...
    /**
     * TODO计算优惠信息  搭配设置值为价格优惠  没有优惠 默认为0
     * 
