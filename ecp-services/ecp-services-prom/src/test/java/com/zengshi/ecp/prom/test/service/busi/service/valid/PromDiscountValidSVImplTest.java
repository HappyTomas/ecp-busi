 ...
 * @author huangjx
 */
public class PromDiscountValidSVImplTest extends EcpServicesTest {

    @Resource
    private IPromValidSV promDiscountValidSV;
    ...
    public void testValid() throws BusinessException {
        ...
        promDTO.setPromTypeCode("code");
        promDTO.setDiscountRule(json);
        try {
            promDiscountValidSV.valid(promDTO);
