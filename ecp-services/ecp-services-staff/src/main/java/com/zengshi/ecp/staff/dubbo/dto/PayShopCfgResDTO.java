...
public class PayShopCfgResDTO extends BaseResponseDTO implements Serializable {
    private Long shopId;
    ...
    private String cerNameUrl;

    private String keyNameUrl;

    public String getCerNameUrl() {
        return cerNameUrl;
    }

    public void setCerNameUrl(String cerNameUrl) {
        this.cerNameUrl = cerNameUrl;
    }

    public String getKeyNameUrl() {
        return keyNameUrl;
    }

    public void setKeyNameUrl(String keyNameUrl) {
        this.keyNameUrl = keyNameUrl;
    }
