...
public class DataAuthResDTO extends BaseResponseDTO {
    
    //规则相关信息
    private List<DataRuleResDTO> ruleArr; //规则下的规则明细配置
	...
	public List<DataRuleResDTO> getRuleArr() {
		return ruleArr;
	}

	public void setRuleArr(List<DataRuleResDTO> ruleArr) {
