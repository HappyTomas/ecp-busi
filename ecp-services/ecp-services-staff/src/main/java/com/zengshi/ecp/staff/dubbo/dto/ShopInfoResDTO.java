...
public class ShopInfoResDTO extends BaseResponseDTO{
    private Long id;
    ...
    private ShopShipTempReqDTO shopShipTempDto;
    ...
    public ShopShipTempReqDTO getShopShipTempDto() {
        return shopShipTempDto;
    }

    public void setShopShipTempDto(ShopShipTempReqDTO shopShipTempDto) {
        this.shopShipTempDto = shopShipTempDto;
    }
    ...
    public String toString() {
        ...
        sb.append(", shopShipTempDto=").append(shopShipTempDto);
