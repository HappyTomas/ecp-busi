...
public class CustInfoResDTO extends BaseResponseDTO implements Serializable{
    private Long id;
    ...
    private Timestamp sensitiveTime;
	...
	public Timestamp getSensitiveTime() {
		return sensitiveTime;
	}

	public void setSensitiveTime(Timestamp sensitiveTime) {
		this.sensitiveTime = sensitiveTime;
	}
