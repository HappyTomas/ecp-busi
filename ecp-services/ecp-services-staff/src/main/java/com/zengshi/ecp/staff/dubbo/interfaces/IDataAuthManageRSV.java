 ...
 * Description: 数据权限接口RSV<br>
 * Date:2015年10月12日上午9:41:31  <br>
 ...
 * @since JDK 1.6
 */
public interface IDataAuthManageRSV {
    /**
     * 
    ...
    /**
     * 
     * findDataAuthById:(根据id查询数据权限). <br/> 
     * 
     * @author linby 
     * @param reqDto
     * @return
    ...
    /**
     * 
     * updateDataAuthById:(根据id更新数据权限规则). <br/> 
     * 
     * @author linby 
     * @param reqDto
     * @throws BusinessException 
    ...
    /**
     * 
     * deleteDataAuthById:(根据id删除数据权限). <br/> 
     * 
     * @author linby 
     * @param reqDto
     * @throws BusinessException 
     ...
     * @since JDK 1.6
     */
    public PageResponseDTO<DataAuthResDTO> listDataAuth(DataAuthReqDTO reqdDto) throws BusinessException;
