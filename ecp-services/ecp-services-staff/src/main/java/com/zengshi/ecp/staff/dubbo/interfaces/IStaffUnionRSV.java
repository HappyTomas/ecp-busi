 ...
 * Description: dubbo层：用户域对外统一服务接口<br>
 ...
 * @since JDK 1.7
 */
public interface IStaffUnionRSV {
    ...
    /**
     * 
     * saveScoreRelForOrderRefund:(订单退款，积分回退操作). <br/> 
     * 订单退款后，已使用的积分返回，已获得的积分扣减掉
     * @author huangxl5
     * @param reqDto
     * @return
     * @throws BusinessException 
    ...
    /**
     * 
     * saveScoreAddForOrderBack:(积分获得：退货同意退款). <br/> 
     * 退货同意退款时，解冻之前冻结的积分，并把积分扣除
     * @author huangxl5
     * @param req
     * @return
     * @throws BusinessException 
    ...
    /**
     * 
     * getSellerInfo:(卖家中心：获取企业店铺列表与企业编码). <br/> 
     * 
     * @author wangbh
