...
import com.zengshi.ecp.staff.service.busi.score.interfaces.IScoreToOrderRWSV;
...
public class StaffUnionRWSVImpl implements IStaffUnionRWSV{
	...
	@Resource(name="scoreToOrderCoreRWSV")
	...
	@Override
	public boolean saveScoreAcctForOrderBackRW(OrderBackMainReqDTO<OrderBackSubReqDTO> rwreq, OrderBackSubReqDTO orderReq)
