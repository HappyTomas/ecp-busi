...
public class AuthMenuReqDTO extends BaseInfo implements Serializable {
    private Long id;
	...
	public String getMenuTitleFull() {
		return menuTitleFull;
	}

	public void setMenuTitleFull(String menuTitleFull) {
		this.menuTitleFull = menuTitleFull;
	}
