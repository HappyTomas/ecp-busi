package com.zengshi.ecp.unpf.test.service.busi.service;
 ...
 * 有赞物流公司数据生成类，上线后需要运行此代码，初始化物流公司数据。
 */
public class YouzanExpressGenerator extends EcpServicesTest {

    @Resource
    private IUnpfShopExpressSV shopExpressSV;
    ...
    @Test
    public void generateExpressTest() {
        //以参数形式提供
        long shopId = 100L;
