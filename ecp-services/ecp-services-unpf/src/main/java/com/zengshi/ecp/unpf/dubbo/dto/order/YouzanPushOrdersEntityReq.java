 ...
 */
public class YouzanPushOrdersEntityReq extends BaseInfo {
    private String id;
    ...
    private List<PushOrdersGoods> orderGoods;
    ...
    public List<PushOrdersGoods> getOrderGoods() {
        return orderGoods;
    }

    public void setOrderGoods(List<PushOrdersGoods> orderGoods) {
        this.orderGoods = orderGoods;
    }

    public static class PushOrdersGoods implements Serializable{
        private String id;
