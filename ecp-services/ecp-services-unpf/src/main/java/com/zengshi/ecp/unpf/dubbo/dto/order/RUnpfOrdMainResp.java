 ...
 * @date: 2016/11/8.
 */
public class RUnpfOrdMainResp extends BaseResponseDTO {
    ...
    private List<RUnpfOrdSubResp> rUnpfOrdSubResps;

    private List<RUnpfOrdDeliveryBatchResp> rUnpfOrdDeliveryBatchResps;
    ...
    public List<RUnpfOrdSubResp> getrUnpfOrdSubResps() {
        return rUnpfOrdSubResps;
    }

    public void setrUnpfOrdSubResps(List<RUnpfOrdSubResp> rUnpfOrdSubResps) {
        this.rUnpfOrdSubResps = rUnpfOrdSubResps;
    }

    public List<RUnpfOrdDeliveryBatchResp> getrUnpfOrdDeliveryBatchResps() {
        return rUnpfOrdDeliveryBatchResps;
    }

    public void setrUnpfOrdDeliveryBatchResps(List<RUnpfOrdDeliveryBatchResp> rUnpfOrdDeliveryBatchResps) {
        this.rUnpfOrdDeliveryBatchResps = rUnpfOrdDeliveryBatchResps;
    }
}
