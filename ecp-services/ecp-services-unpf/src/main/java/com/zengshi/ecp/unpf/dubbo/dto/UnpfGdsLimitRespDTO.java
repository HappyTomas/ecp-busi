...
public class UnpfGdsLimitRespDTO extends BaseResponseDTO{
    private Long id;
    ...
    private String gdsCatgCodeName;
    ...
    public void setGdsCatgCode(String gdsCatgCode) {
        this.gdsCatgCode = gdsCatgCode;
    }

    public String getGdsCatgCodeName() {
        return gdsCatgCodeName;
    }

    public void setGdsCatgCodeName(String gdsCatgCodeName) {
        this.gdsCatgCodeName = gdsCatgCodeName;
    }
