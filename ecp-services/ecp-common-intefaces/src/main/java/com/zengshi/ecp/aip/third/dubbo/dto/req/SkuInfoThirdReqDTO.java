...
public class SkuInfoThirdReqDTO  extends BaseInfo{
    ...
    private Long quantities;//库存数量 
    
    private String props;//单品属性串 pid:vid,pid:vid格式
    ...
    public String toString() {
        ...
        sb.append(", commonPrice=").append(commonPrice);
        sb.append(", appSpecPrice=").append(appSpecPrice);
        sb.append("]");
        return sb.toString();
    }
