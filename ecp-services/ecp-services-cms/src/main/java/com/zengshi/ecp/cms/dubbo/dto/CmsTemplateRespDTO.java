 ...
 * @since JDK 1.6 
 */  
public class CmsTemplateRespDTO extends BaseResponseDTO {
     ...
     * 模板分类翻译
     */
    private String templateClassZH;
    ...
    public String toString() {
        ...
        sb.append(", templateFileUrl=").append(templateFileUrl);
    ...
    public String getTemplateClassZH() {
        return templateClassZH;
    }

    public void setTemplateClassZH(String templateClassZH) {
        this.templateClassZH = templateClassZH;
    }
