...
public class CmsPageAttrPubRespDTO extends BaseResponseDTO {
    private Long id;

    private Long pageAttrId;
    ...
    public Long getPageAttrId() {
        return pageAttrId;
    }

    public void setPageAttrId(Long pageAttrId) {
        this.pageAttrId = pageAttrId;
    }
    ...
    public String toString() {
        ...
        sb.append(", pageAttrId=").append(pageAttrId);
