...
public class CmsGdsCategoryRespDTO extends BaseResponseDTO {
    
    /*--------other--------*/
	private List<CmsGdsCategoryRespDTO> cmsChildCatg= null;//子节点
    
    private List<CmsGdsCategoryRespDTO> cmsShowChildCatg= null;//右边显示子节点
    /**
     * 状态翻译
     */
    ...
    public List<CmsGdsCategoryRespDTO> getCmsChildCatg() {
        return cmsChildCatg;
    }

    public void setCmsChildCatg(List<CmsGdsCategoryRespDTO> cmsChildCatg) {
        this.cmsChildCatg = cmsChildCatg;
    }

    public List<CmsGdsCategoryRespDTO> getCmsShowChildCatg() {
        return cmsShowChildCatg;
    }

    public void setCmsShowChildCatg(List<CmsGdsCategoryRespDTO> cmsShowChildCatg) {
        this.cmsShowChildCatg = cmsShowChildCatg;
    }
