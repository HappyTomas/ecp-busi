 ...
 * @since JDK 1.6 
 */  
public class CmsSiteRespDTO extends BaseResponseDTO {
    ...
    public void setStatusZH(String statusZH) {
        this.statusZH = statusZH == null ? null : statusZH.trim();
    }
    ...
    public void setIsdefaultZH(String isdefaultZH) {
        this.isdefaultZH = isdefaultZH == null ? null : isdefaultZH.trim();
    }
