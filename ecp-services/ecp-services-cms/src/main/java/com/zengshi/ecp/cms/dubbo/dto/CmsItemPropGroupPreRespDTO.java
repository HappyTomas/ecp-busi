...
public class CmsItemPropGroupPreRespDTO extends BaseResponseDTO {
    
    /*--------------------------以下为model后添加的字段 start--------------------------*/
    /**
     * 布局项属性的属性值LIST
     */
    private List<CmsItemPropGroupValuePreRespDTO> itemPropGroupValuePreRespDTOList;
    /*--------------------------以下为model后添加的字段 end------------------------*/
    ...
    public List<CmsItemPropGroupValuePreRespDTO> getItemPropGroupValuePreRespDTOList() {
        return itemPropGroupValuePreRespDTOList;
    }

    public void setItemPropGroupValuePreRespDTOList(
            List<CmsItemPropGroupValuePreRespDTO> itemPropGroupValuePreRespDTOList) {
        this.itemPropGroupValuePreRespDTOList = itemPropGroupValuePreRespDTOList;
    }
}
