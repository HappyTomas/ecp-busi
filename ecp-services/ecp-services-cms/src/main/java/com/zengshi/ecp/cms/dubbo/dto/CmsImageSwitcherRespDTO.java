...
public class CmsImageSwitcherRespDTO extends BaseResponseDTO implements Serializable {
    private Long id;
    ...
    private String twicePicUrl;

    public String getTwicePicUrl() {
        return twicePicUrl;
    }

    public void setTwicePicUrl(String twicePicUrl) {
        this.twicePicUrl = twicePicUrl;
    }
    ...
    public void setTwicePicName(String twicePicName) {
        this.twicePicName = twicePicName;
    }
