...
public interface ICmsSiteRSV {
    ...
    /** 
     * changeStatusCmsSiteBatch:(批量使生效、失效). <br/> 
     * TODO(这里描述这个方法适用条件 – 可选).<br/> 
     * TODO(这里描述这个方法的执行流程 – 可选).<br/> 
     * TODO(这里描述这个方法的使用方法 – 可选).<br/> 
     * TODO(这里描述这个方法的注意事项 – 可选).<br/> 
    ...
    /** 
     * doDefaultCmsSiteBatch:(批量设置默认站点). <br/> 
     * TODO(这里描述这个方法适用条件 – 可选).<br/> 
     * TODO(这里描述这个方法的执行流程 – 可选).<br/> 
     * TODO(这里描述这个方法的使用方法 – 可选).<br/> 
     * TODO(这里描述这个方法的注意事项 – 可选).<br/> 
     ...
     * @since JDK 1.6 
     */ 
    public List<CmsSiteRespDTO> queryCmsSiteList(CmsSiteReqDTO cmsSiteReqDTO) throws BusinessException;
    
    /** 
     * queryCmsDefaultSiteList:(获取默认站点). <br/> 
     * TODO(1.1先从缓存获取，如果获取没有，再从表中获取默认的站点，返回为一个LIST).<br/> 
     * TODO(这里描述这个方法的执行流程 – 可选).<br/> 
     * TODO(这里描述这个方法的使用方法 – 可选).<br/> 
     * TODO(这里描述这个方法的注意事项 – 可选).<br/> 
     * 
