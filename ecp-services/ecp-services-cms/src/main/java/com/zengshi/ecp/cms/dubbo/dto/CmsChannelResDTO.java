 ...
 * @since JDK 1.6
 * 
 * 栏目数据表T_CMS_CHANNEL出参模型DTO
 */
public class CmsChannelResDTO extends BaseResponseDTO{
/*--------------------------以下为model后添加的字段 start--------------------------*/
    
    /**
     * 状态翻译
     */
    private String siteInfoZH;
    /**
     * 是否状态翻译
     */
    private String isresiteinfoZH;
    /**
     * 子节点列表
     */
    private List<CmsChannelResDTO> childList= null;
    /**
     * 广告图片URL
     */
    ...
    public String getSiteInfoZH() {
        return siteInfoZH;
    }

    public void setSiteInfoZH(String siteInfoZH) {
        this.siteInfoZH = siteInfoZH;
    }
    
    public List<CmsChannelResDTO> getChildList() {
        return childList;
    }

    public void setChildList(List<CmsChannelResDTO> childList) {
        this.childList = childList;
    }
    
    public String getIsresiteinfoZH() {
        return isresiteinfoZH;
    }

    public void setIsresiteinfoZH(String isresiteinfoZH) {
        this.isresiteinfoZH = isresiteinfoZH;
    }
