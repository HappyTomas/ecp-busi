...
public class CmsModularParaPropReqDTO extends BaseInfo{
     ...
     * 布局类型LIST
     */
    private List<CmsModularPropValReqDTO> modularPropValReqDTOList;
    /**
     * 状态SET，用于查询
     */
    ...
    public List<CmsModularPropValReqDTO> getModularPropValReqDTOList() {
        return modularPropValReqDTOList;
    }

    public void setModularPropValReqDTOList(List<CmsModularPropValReqDTO> modularPropValReqDTOList) {
        this.modularPropValReqDTOList = modularPropValReqDTOList;
    }
