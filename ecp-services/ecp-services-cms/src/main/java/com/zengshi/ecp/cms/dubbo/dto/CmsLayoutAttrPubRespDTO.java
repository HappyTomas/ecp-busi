...
public class CmsLayoutAttrPubRespDTO extends BaseResponseDTO {
    private Long id;

    private Long layoutAttrId;
    ...
    public Long getLayoutAttrId() {
        return layoutAttrId;
    }

    public void setLayoutAttrId(Long layoutAttrId) {
        this.layoutAttrId = layoutAttrId;
    }
    ...
    public String toString() {
        ...
        sb.append(", layoutAttrId=").append(layoutAttrId);
