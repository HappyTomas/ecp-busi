...
public class CmsLayoutPreReqDTO extends BaseInfo {
     ...
     * 页面布局项预览LIST
     */
    private List<CmsLayoutItemPreReqDTO> layoutItemPreList;
    ...
    public List<CmsLayoutItemPreReqDTO> getLayoutItemPreList() {
        return layoutItemPreList;
    }

    public void setLayoutItemPreList(List<CmsLayoutItemPreReqDTO> layoutItemPreList) {
        this.layoutItemPreList = layoutItemPreList;
    }
