 ...
 * @since JDK 1.6
 */
public interface ICmsGdsCategorySV extends IGeneralSQLSV {
	/**
	 * queryGdsCategoryByPK:(这里用一句话描述这个方法的作用). <br/>
	 ...
	 * 
	 * @author huangxm9
	 * @param CmsGdsCategoryReqDTO
	 * @return
	 * @throws BusinessException
	 * @since JDK 1.6
	 */
//	public CmsGdsCategoryRespDTO queryGdsCategoryByPK(CmsGdsCategoryReqDTO reqDTO) throws BusinessException;
	/**
	...
	/**
	 * 
	 * queryCmsCategoryInfo:(这里用一句话描述这个方法的作用). <br/> 
	 * TODO(这里描述这个方法适用条件 – 可选).<br/> 
	 * TODO(这里描述这个方法的执行流程 – 可选).<br/> 
	 * TODO(这里描述这个方法的使用方法 – 可选).<br/> 
	 * TODO(这里描述这个方法的注意事项 – 可选).<br/> 
