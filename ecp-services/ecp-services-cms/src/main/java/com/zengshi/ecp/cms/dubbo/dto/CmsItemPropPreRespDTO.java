...
public class CmsItemPropPreRespDTO extends BaseResponseDTO {
    
    /*--------------------------以下为model后添加的字段 start--------------------------*/
    /**
     * 布局项属性的属性值LIST
     */
    private List<CmsItemPropValuePreRespDTO> itemPropValuePreRespDTOList;
    /**
     * 布局项属性组LIST
     */
    private List<List<CmsItemPropGroupPreRespDTO>> itemPropGroupPreRespDTOList;
    /*--------------------------以下为model后添加的字段 end------------------------*/
    ...
    public List<CmsItemPropValuePreRespDTO> getItemPropValuePreRespDTOList() {
        return itemPropValuePreRespDTOList;
    }

    public void setItemPropValuePreRespDTOList(
            List<CmsItemPropValuePreRespDTO> itemPropValuePreRespDTOList) {
        this.itemPropValuePreRespDTOList = itemPropValuePreRespDTOList;
    }
    
    public List<List<CmsItemPropGroupPreRespDTO>> getItemPropGroupPreRespDTOList() {
        return itemPropGroupPreRespDTOList;
    }

    public void setItemPropGroupPreRespDTOList(
            List<List<CmsItemPropGroupPreRespDTO>> itemPropGroupPreRespDTOList) {
        this.itemPropGroupPreRespDTOList = itemPropGroupPreRespDTOList;
    }
    ...
    public void setItemPropGroupPreRespDTOList(
            List<CmsItemPropGroupPreRespDTO> itemPropGroupPreRespDTOList) {
        this.itemPropGroupPreRespDTOList = itemPropGroupPreRespDTOList;
    }*/
}
