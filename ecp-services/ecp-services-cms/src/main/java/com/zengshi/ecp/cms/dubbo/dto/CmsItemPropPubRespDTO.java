...
public class CmsItemPropPubRespDTO extends BaseResponseDTO {
    
    /*--------------------------以下为model后添加的字段 start--------------------------*/
    /**
     * 布局项属性的属性值LIST
     */
    private List<CmsItemPropValuePubRespDTO> itemPropValuePubRespDTOList;
    /**
     * 布局项属性组LIST
     */
    private List<List<CmsItemPropGroupPubRespDTO>> itemPropGroupPubRespDTOList;
    /*--------------------------以下为model后添加的字段 end------------------------*/
    ...
    public List<CmsItemPropValuePubRespDTO> getItemPropValuePubRespDTOList() {
        return itemPropValuePubRespDTOList;
    }

    public void setItemPropValuePubRespDTOList(
            List<CmsItemPropValuePubRespDTO> itemPropValuePubRespDTOList) {
        this.itemPropValuePubRespDTOList = itemPropValuePubRespDTOList;
    }
    
    public List<List<CmsItemPropGroupPubRespDTO>> getItemPropGroupPubRespDTOList() {
        return itemPropGroupPubRespDTOList;
    }

    public void setItemPropGroupPubRespDTOList(
            List<List<CmsItemPropGroupPubRespDTO>> itemPropGroupPubRespDTOList) {
        this.itemPropGroupPubRespDTOList = itemPropGroupPubRespDTOList;
    }
