 ...
 * @since JDK 1.6 
 */  
public class CmsFloorAttrCountRespDTO extends BaseResponseDTO {
    ...
    public String getFloorAttrZH() {
        return floorAttrZH;
    }

    public void setFloorAttrZH(String floorAttrZH) {
        this.floorAttrZH = floorAttrZH;
    }
