...
public class Trades {
    ...
    public void setCouponDetails(List<String> couponDetails) {
    ...
    public void setPromotionDetails(List<String> promotionDetails) {
    ...
    public void setSubTrades(List<String> subTrades) {
        this.subTrades = subTrades;
    }

    public List<String> getSubTrades() {
        return subTrades;
    }
