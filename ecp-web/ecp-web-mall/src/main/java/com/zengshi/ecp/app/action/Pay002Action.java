...
import com.zengshi.ecp.app.req.Pay002Req;
import com.zengshi.ecp.app.resp.Pay002Resp;
 ...
 */  
@Service("pay002")
@Action(bizcode = "pay002", userCheck = true)
@Scope("prototype")
public class Pay002Action extends AppBaseAction<Pay002Req, Pay002Resp> {
    ...
    private static final String MODULE = Pay002Action.class.getName();
