...
import com.zengshi.ecp.app.req.Pay001Req;
import com.zengshi.ecp.app.resp.Pay001Resp;
 ...
 */  
@Service("pay001")
@Action(bizcode = "pay001", userCheck = true)
@Scope("prototype")
public class Pay001Action extends AppBaseAction<Pay001Req, Pay001Resp> {
    
    @Resource
    private IPayWayRSV payWayRSV;
    
    private static final String MODULE = Pay001Action.class.getName();
