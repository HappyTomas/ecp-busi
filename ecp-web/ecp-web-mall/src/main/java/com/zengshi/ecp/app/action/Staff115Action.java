...
import com.zengshi.ecp.app.req.Staff115Req;
import com.zengshi.ecp.app.resp.Staff115Resp;
 ...
 * Description: 用户域：取消店铺收藏action<br>
...
@Service("staff115")
@Action(bizcode="staff115", userCheck=true)
@Scope("prototype")
public class Staff115Action extends AppBaseAction<Staff115Req, Staff115Resp> {
