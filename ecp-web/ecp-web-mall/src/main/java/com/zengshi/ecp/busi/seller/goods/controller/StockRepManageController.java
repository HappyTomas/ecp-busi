...
import com.zengshi.ecp.busi.seller.goods.vo.rep.AreaInfo;
import com.zengshi.ecp.busi.seller.goods.vo.rep.StockRepAddInitInfo;
import com.zengshi.ecp.busi.seller.goods.vo.rep.StockRepDelInfo;
import com.zengshi.ecp.busi.seller.goods.vo.rep.StockRepEditInfo;
import com.zengshi.ecp.busi.seller.goods.vo.rep.StockRepInfo;
 ...
 */
@Controller
@RequestMapping(value = "/seller/goods/stockrep")
public class StockRepManageController extends EcpBaseController {
    ...
    public String add(Model model, StockRepInfo stockRepInfo) throws Exception {
       ...
       return "/seller/goods/rep/rep-add";
    }
    ...
    public String addAdaptListInit(Model model, StockRepInfo stockRepInfo) throws Exception {
        ...
        return "/seller/goods/rep/repPop/rep-adapt";
    }
    ...
    public String pageInit(Model model,StockRepInfo stockRepInfo) {
        LogUtil.debug(MODULE, "请求参数为：" + stockRepInfo.toString());
        if(null != stockRepInfo.getShopId()){
        	model.addAttribute("shopId", stockRepInfo.getShopId());
        }
        return "/seller/goods/rep/rep-grid";
    }
    ...
    public String listRep(Model model, @Valid
    StockRepInfo stockRepInfo) throws Exception {
        ...
        if (t.getResult() == null) {
            t.setResult(Collections.<StockRepPageRespDTO> emptyList());
        }
        ...
        model.addAttribute("gridResult",t);
        
        return "/seller/goods/rep/repPop/rep-list";
    ...
    Long shopId) throws Exception {
        ...
        return "/seller/goods/rep/repPop/rep-add-selcity";
    }
    ...
    public EcpBaseResponseVO delRep(StockRepDelInfo delInfo) throws Exception {
        ...
        try{
        	...
        	LogUtil.error(MODULE, "仓库失效失败！", e);
        	respVO.setResultFlag(EcpBaseResponseVO.RESULT_FLAG_FAILURE);
			if(e instanceof BusinessException){
				respVO.setResultMsg(((BusinessException)e).getErrorMessage());
			}else{
    ...
    public String editRep(Model model, StockRepEditInfo editInfo) throws Exception {
        ...
        return "/seller/goods/rep/rep-edit";
    ...
    Long shopId) throws Exception {
        ...
        model.addAttribute("cityAreas", areaInfos);
        return "/seller/goods/rep/repPop/rep-edit-selcity";
    }
    ...
    public String check(Model model, StockRepEditInfo stockEditInfo) throws Exception {
        ...
        return "/seller/goods/rep/rep-check";
    }
    ...
    Long shopId) throws Exception {
        ...
        model.addAttribute("cityAreas", areaInfos);
        return "/seller/goods/rep/repPop/rep-check-selcity";
    }
