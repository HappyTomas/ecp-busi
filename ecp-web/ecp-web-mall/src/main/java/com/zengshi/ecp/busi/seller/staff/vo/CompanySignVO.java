 ...
 * Description: 企业入驻申请vo<br>
 * Date:2016-4-13下午5:14:27  <br>
 ...
 * @since JDK 1.6
 */
public class CompanySignVO implements Serializable{
    private Long id;
     ...
     * licencePathURL. 
     * 
     * @return  the licencePathURL 
     * @since   JDK 1.6 
     */
    public String getLicencePathURL() {
        return licencePathURL;
    }

    /** 
     * licencePathURL. 
     * 
     * @param   licencePathURL    the licencePathURL to set 
     * @since   JDK 1.6 
     */
    public void setLicencePathURL(String licencePathURL) {
        this.licencePathURL = licencePathURL;
    }

    /** 
     * taxPathURL. 
     * 
     * @return  the taxPathURL 
     * @since   JDK 1.6 
     */
    public String getTaxPathURL() {
        return taxPathURL;
    }
     ...
     * taxPathURL. 
     * 
     * @param   taxPathURL    the taxPathURL to set 
     * @since   JDK 1.6 
     */
    public void setTaxPathURL(String taxPathURL) {
        this.taxPathURL = taxPathURL;
    }

    /** 
     * legalPersonImageURL. 
     * 
     * @return  the legalPersonImageURL 
     * @since   JDK 1.6 
     */
    public String getLegalPersonImageURL() {
        return legalPersonImageURL;
    }

    /** 
     * legalPersonImageURL. 
     * 
     * @param   legalPersonImageURL    the legalPersonImageURL to set 
     * @since   JDK 1.6 
     */
    public void setLegalPersonImageURL(String legalPersonImageURL) {
        this.legalPersonImageURL = legalPersonImageURL;
    }
