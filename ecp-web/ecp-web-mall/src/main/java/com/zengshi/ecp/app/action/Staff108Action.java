...
import com.zengshi.ecp.app.req.Staff108Req;
import com.zengshi.ecp.app.resp.Staff108Resp;
 ...
 * Description: 用户域：根据用户查询默认收货地址action<br>
...
@Service("staff108")
@Action(bizcode="staff108", userCheck=true)
@Scope("prototype")
public class Staff108Action extends AppBaseAction<Staff108Req, Staff108Resp> {
    ...
    protected void getResponse() throws BusinessException, SystemException, Exception {
        ...
        CustAddrResDTO result = custAddrRsv.findDefaultAddr(addrReq);
        
        /*3、返回结果*/
        ObjectCopyUtil.copyObjValue(result, this.response, null, false);
    }
