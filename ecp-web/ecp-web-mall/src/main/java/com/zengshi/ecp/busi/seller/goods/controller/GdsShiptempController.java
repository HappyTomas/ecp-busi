...
import com.zengshi.ecp.busi.seller.goods.vo.GdsShipAddress;
 ...
 * @since JDK 1.6
 */
@RequestMapping(value = "seller/gdsshiptemp")
@Controller
public class GdsShiptempController extends EcpBaseController {
    ...
    private static String URL = "/seller/goods/gdsShipment";
    ...
    public String init(Model model, GdsShopVO gsShopVO) {
        ...
        try {
            ...
            model.addAttribute("shipPage",pageInfo);
//            respVO = EcpBasePageRespVO.buildByPageResponseDTO(pageInfo);
    ...
    public String gridList(Model model, GdsShiptempVO gdsShiptempVO) {
