...
import com.zengshi.ecp.app.req.Gds007Req;
import com.zengshi.ecp.app.resp.Gds007Resp;
 ...
 */
@Service("gds007")
@Action(bizcode = "gds007", userCheck = false)
@Scope("prototype")
public class Gds007Action extends AppBaseAction<Gds007Req, Gds007Resp> {
    ...
    private static final String MODULE = Gds007Action.class.getName();
    
    @Override
    protected void getResponse() throws BusinessException, SystemException, Exception {
       
        Gds007Req gds007Req = this.request;
        Gds007Resp gds007Resp = this.response; 
