        				...
        				success : function(returnInfo) {
        					...
        					if(returnInfo.respDto.gdsTypeRespDTO.ifNeedstock=="1"){//需要库存
        						if(returnInfo.stockStatus == '00'){
            						...
            						if(_onceBuyBtn.hasClass('mbtn-orange')){
            							_onceBuyBtn.attr("disabled",'true');
            							_onceBuyBtn.removeClass('mbtn-orange');
            							_onceBuyBtn.addClass('mbtn-disable');
            						}
            						...
            						if(_onceBuyBtn.hasClass('mbtn-disable')){
            							_onceBuyBtn.removeAttr('disabled');
            							_onceBuyBtn.removeClass('mbtn-disable');
            							_onceBuyBtn.addClass('mbtn-orange');
            						}
...
var ladderPriceHtml = function(){
	console.log("ladderPriceHtml");
	var price = $("#prices").val();
	 for(var i in price){
	        if (price.hasOwnProperty(i)) { //filter,只输出man的私有属性
