    ...
    var pageInit = function(){
        ...
        var init = function(){
        	...
        	$('#btnFormReset').click(function(){
        		//ebcForm.resetForm('#searchSkuForm');
        		$('#gdsName').val('');
        		$('#gdsStatus').val('11');
        		$('#platCatgs').val('');
        		$('#mainCatgsName').val('');
			...
			$('#gdsQueryBtn').click(function() {
				...
				$('#skuListDiv').load(GLOBAL.WEBROOT + '/seller/coupsku/skugrid',{"gdsStatus":gdsStatus,"gdsName":gdsName,"shopId":shopId,"platCatgs":platCatgs,"siteId":siteId});
			});
			//加载初始化
			$('#gdsQueryBtn').click();
