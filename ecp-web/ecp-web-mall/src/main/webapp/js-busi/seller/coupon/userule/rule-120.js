...
var rule120={ 
		qryShopGrid:function(_shopId){
			bDialog.open({
				title : '店铺选择',
				width : 800,
				height : 550,
				url : GLOBAL.WEBROOT + "/seller/promshop?shopId="+_shopId,
	...
	initShopList:function(_shopIds){
			...
			//ajax请求
			$.eAjax({
				url : GLOBAL.WEBROOT + "/seller/coupshop/shopList",
				...
				success : function(returnInfo) {
					...
					rule120.viewHide(hide,$('#shop-table-id-120'));
				}
			});
		},
		//查看隐藏 控件
