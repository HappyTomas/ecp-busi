	...
	var pageInit = function() {
		...
		var init = function() {
			 ...
			 $("#btnCatg110").click(function(){
				     ...
				     rule110.queryCatg110(_sid,_shopId);
				 });
			 //商品选择事件
...
var rule110={
  ...
  //单品checkbox选择
	...
	//查询优惠券
    queryCatg110:function(_sid,_shopId){ 
  ...
  //促销分类列表
	initCatgList:function(_catgIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/seller/coupcatg/catgList",
	...
	initGdsList:function(_gdsIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/seller/coupgds/gdsList",
	...
	initSkuList:function(_skuIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/seller/coupsku/skuList",
