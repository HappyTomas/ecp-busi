    ...
    var pageInit = function(){
        ...
        /*	//checkbox商品选择事件
			...
			$('#gdsQueryBtn').click(function() {
				...
				$('#goodsListDiv').load(GLOBAL.WEBROOT + '/seller/gdsprom/goodslist',{"gdsStatus":gdsStatus,"gdsName":gdsName,"isbn":isbn,"shopId":shopId,"platCatgs":platCatgs,"siteId":siteId});
			});
			//加载初始化
			$('#gdsQueryBtn').click();
