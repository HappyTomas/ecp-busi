...
(function($) {
	var Constants = {
			...
			url:GLOBAL.WEBROOT+"/search/asyncData/selector/getNodes?catgType=1&catgCode="+$("#tab_1").attr("value")
			//url:GLOBAL.WEBROOT+"/seller/goods/category/asyncData/selector/getNodes?catgType=1"
	...
	$.fn.mcDropDown.change = function(catgCode){
		if(catgCode!=null){
			Constants.url = GLOBAL.WEBROOT+"/search/asyncData/selector/getNodes?catgType=1&catgCode="+catgCode;
		}
	...
	var categoryTree = {
			...
			/*settingSearch : {
					...
					async: {
    					enable: true,
    					url:GLOBAL.WEBROOT+"/seller/goods/category/asyncData/catgsearch",
    					type:"post",
    					otherParam:{
    						"catgType":'1',
    						"catgName":function(){
