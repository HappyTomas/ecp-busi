...
import com.zengshi.ecp.app.req.Pay104Req;
import com.zengshi.ecp.app.resp.Pay104Resp;
 ...
 */  
@Service("pay104")
@Action(bizcode = "pay104", userCheck = true)
@Scope("prototype")
public class Pay104Action extends AppBaseAction<Pay104Req, Pay104Resp> {
    ...
    private static final String MODULE = Pay104Action.class.getName();
