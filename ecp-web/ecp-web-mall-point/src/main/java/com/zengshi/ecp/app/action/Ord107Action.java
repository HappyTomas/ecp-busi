...
import com.zengshi.ecp.app.req.Ord107Req;
import com.zengshi.ecp.app.resp.Ord107Resp;
 ...
 */
@Service("ord107")
@Action(bizcode = "ord107", userCheck = true)
@Scope("prototype")
public class Ord107Action extends AppBaseAction<Ord107Req, Ord107Resp> {

    @Resource
    private IOrdMainRSV ordMainRSV;

    private static final String MODULE = Ord107Action.class.getName();
