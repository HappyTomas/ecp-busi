...
public class PayResultController extends EcpBaseController {
    ...
    public String hongpay(Model model,HttpServletRequest request) {
        return this.showResultPage(model,"9002", this.getParamMap(request));
    }
    ...
    public String alipay(Model model,HttpServletRequest request) {
        return this.showResultPage(model,"9003", this.getParamMap(request));
    }
    ...
    public String abcpay(Model model,HttpServletRequest request) {
        return this.showResultPage(model,"9004", this.getParamMap(request));
    }
     ...
     * @since JDK 1.6
     */
	private String showResultPage(Model model,String payWay,Map<String, String> paramMap) {
