 ...
 */
@Controller
@RequestMapping(value="/order/member")
public class MemberOrderController extends EcpBaseController{

    private final String MODULE = MemberOrderController.class.getName();
    @Resource
    ...
    private String URL = "/order/member";
