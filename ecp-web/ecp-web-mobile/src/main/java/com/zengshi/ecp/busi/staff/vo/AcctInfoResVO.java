...
public class AcctInfoResVO extends BaseResponseDTO implements Serializable {
    ...
    private String totalMoneyYun;

    private Long balance;
    
    private String balanceYun;
    ...
    public String getTotalMoneyYun() {
        return totalMoneyYun;
    }

    public void setTotalMoneyYun(String totalMoneyYun) {
        this.totalMoneyYun = totalMoneyYun;
    }

    public String getBalanceYun() {
        return balanceYun;
    }

    public void setBalanceYun(String balanceYun) {
        this.balanceYun = balanceYun;
    }
