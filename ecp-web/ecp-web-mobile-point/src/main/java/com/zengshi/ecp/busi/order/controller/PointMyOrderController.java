 ...
 */
@Controller
@RequestMapping(value="/point/order/my")
public class PointMyOrderController extends EcpBaseController{

    private final String MODULE = PointMyOrderController.class.getName();
    @Resource
    ...
    public ROrdersRespVO scrollData(Model model,RQueryOrderReqVO vo,String status){
        ...
        for(RCustomerOrdResponse customerData:rdors.getResult()){
            ...
            for(SOrderDetailsSub detailsSub:customerData.getsOrderDetailsSubs()){
                ...
                scores+=detailsSub.getOrderSubScore();
            }
