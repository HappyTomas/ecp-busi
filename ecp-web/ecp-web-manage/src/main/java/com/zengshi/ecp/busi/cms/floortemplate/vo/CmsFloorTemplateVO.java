package com.zengshi.ecp.busi.cms.floortemplate.vo;
...
public class CmsFloorTemplateVO extends EcpBasePageReqVO implements Serializable{
    ...
    @NotNull(message="{cms.floortemplate.templateName.notnull.err}")
    ...
    @NotNull(message="{cms.floortemplate.floorPlaceNum.notnull.err}")
    private Integer floorPlaceNum;
    
    @NotNull(message="{cms.floortemplate.templateNo.notnull.err}")
