...
public class ParameterController extends EcpBaseController {
	 ...
	 */
	@RequestMapping()
	public String init(Model model, ParameterVO vo) {
		model.addAttribute("paraCode", vo.getParaCode());
		model.addAttribute("paraDesc", vo.getParaDesc());
		model.addAttribute("paraValue", vo.getParaValue());
	 ...
	 */
	@RequestMapping(value = "/view/{para}")
	public String view(Model model,@PathVariable("para")String para,ParameterVO vo) {
		SysCfgReqDTO sysCfgReqDTO = new SysCfgReqDTO();
		sysCfgReqDTO.setParaCode(para);
	 ...
	 */
	@RequestMapping(value = "/edit/{para}")
	public String edit(Model model,@PathVariable("para")String para,ParameterVO vo) {
		SysCfgReqDTO sysCfgReqDTO = new SysCfgReqDTO();
		sysCfgReqDTO.setParaCode(para);
		SysCfgResDTO sysCfgResDTO = this.sysCfgRSV.fetchByparaCode(sysCfgReqDTO);
		model.addAttribute("sysCfgResDTO", sysCfgResDTO);	
