package com.zengshi.ecp.busi.cms.advertise.controller;
...
public class CmsAdvertiseController extends EcpBaseController {
    ...
    private String URL = "/cms/advertise/advertise";//返回页面的基本路径 
    private String URL_OPEN = "/cms/advertise/open/advertise";//返回页面的弹出窗路径
    ...
    public String grid(Model model,
            @ModelAttribute("searchParams") String searchParams,String shopId) throws Exception{
    ...
    public String edit(Model model,
        ...
        try {
            ...
            //cmsAdvertiseRespDTO.setNailVfsUrl(ConstantTool.getImageUrl(cmsAdvertiseRespDTO.getNailVfsId(),"200x150!"));
            model.addAttribute("respVO",cmsAdvertiseRespDTO);
    ...
    public String saveForm(@Valid @ModelAttribute("demoCfg") DemoCfgVO demoCfg, BindingResult result){
        ...
        if(result.hasErrors()){
            ...
            return "redirect:/advertise/grid";
        }
    }
    ...
    public Model gridList(Model model, @ModelAttribute("searchVO") CmsAdvertiseVO searchVO) throws Exception{
        ...
        if(CollectionUtils.isNotEmpty(respList)){
            for(CmsAdvertiseRespDTO dto:respList){
                ...
                dto.setNailVfsUrl(ImageUtil.getImageUrl(dto.getNailVfsId()+"_"+"120x50!"));
                //3.2调用店铺，返回店铺信息
