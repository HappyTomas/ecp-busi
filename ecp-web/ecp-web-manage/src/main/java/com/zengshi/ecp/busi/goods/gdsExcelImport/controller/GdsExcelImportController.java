...
import com.zengshi.ecp.busi.goods.gdsExcelImport.vo.ExcelImportGdsModelVO;
...
@Controller
@RequestMapping("/goods/excelImport")
public class GdsExcelImportController extends GdsBaseController {
	...
	public String pageInit(Model model) throws Exception {
		...
		return "/goods/gdsExcelImport/gds-importdata";
	}
	...
	public GdsExcelImpTempVO importTempData(Model model, GdsExcelImpLogReqInfo vo) {
		...
		try {
			...
			excelImpLogReqDTO.setOptType(GdsConstants.GdsExcelImpLog.GDS_EXCEL_IMP_NEW);
	...
	public String watchResultList(Model model, ListResultReqVO reqVO) throws Exception {
		return "/goods/gdsExcelImport/list/list-result";
	}
