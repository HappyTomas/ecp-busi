...
import com.zengshi.ecp.goods.dubbo.dto.gdsinfo.*;
import com.zengshi.ecp.goods.dubbo.dto.gdsinfores.*;
...
import com.zengshi.ecp.goods.dubbo.interfaces.*;
...
//            List<BaseParamDTO> gdsTypeCodeList = BaseParamUtil.fetchParamList("GDS_INFO_TYPE");
            ...
            if(resultDto!=null){
                ...
                skuListStr = JSONArray.fromObject(resultDto.getSkus(),jsonConfig).toString().replaceAll("\'", "\\\\'").replaceAll("\"", "\'");
                if(CollectionUtils.isNotEmpty(resultDto.getMedias())){
