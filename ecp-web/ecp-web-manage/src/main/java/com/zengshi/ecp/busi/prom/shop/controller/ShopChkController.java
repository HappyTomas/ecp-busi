package com.zengshi.ecp.busi.prom.shop.controller;
...
import com.zengshi.ecp.busi.prom.shop.vo.PromChkVO;
import com.zengshi.ecp.busi.prom.shop.vo.PromInfoReqVO;
...
public class ShopChkController extends EcpBaseController {
	...
	@ResponseBody
	public Model gridList(Model model,PromInfoReqVO vo) throws Exception{
	    
		PromInfoDTO rdto = vo.toBaseInfo(PromInfoDTO.class);
		//查询条件
		ObjectCopyUtil.copyObjValue(vo, rdto, "", false);
		
		PageResponseDTO<PromInfoResponseDTO> t = promQueryRSV.queryPromInfoListByPlat(rdto);
