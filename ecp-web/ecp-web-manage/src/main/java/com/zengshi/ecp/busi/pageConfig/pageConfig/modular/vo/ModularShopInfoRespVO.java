 ...
 * @since JDK 1.6
 */
public class ModularShopInfoRespVO extends BaseResponseDTO {
    /** 
     * serialVersionUID:TODO(用一句话描述这个变量表示什么). 
     * @since JDK 1.6 
     */ 
    private static final long serialVersionUID = 7982278845841328031L;
    ...
    private double evalRate;//好评率
    
    private Long favNum;//商品数量
