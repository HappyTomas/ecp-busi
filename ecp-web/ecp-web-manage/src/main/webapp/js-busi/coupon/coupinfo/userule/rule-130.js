...
var rule130={
  ...
  //促销分类列表
	initCatgList:function(_catgIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/coupcatg/catgblackList",
	...
	initGdsList:function(_gdsIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/coupgds/gdsblackList",
	...
	initSkuList:function(_skuIds){
		...
		//ajax请求
		$.eAjax({
			url : GLOBAL.WEBROOT + "/coupsku/skublackList",
