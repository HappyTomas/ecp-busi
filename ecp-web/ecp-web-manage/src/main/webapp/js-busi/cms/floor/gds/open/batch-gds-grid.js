	...
	init : function(){//初始化
		...
		$("#gds_grid_dataGridTable").initDT({
	        ...
	        "aoColumns": [
				...
				{ "mData": "gdsTypeName", "sTitle":"商品类型","sWidth":"120px","bSortable":false,"mRender": function(data,type,row){
					return SearchObj.HTMLEncode(data);
				}},
				...
				{ "mData": "updateTime", "sTitle":"上架日期","sWidth":"120px","bSortable":false,"mRender": function(data,type,row){
