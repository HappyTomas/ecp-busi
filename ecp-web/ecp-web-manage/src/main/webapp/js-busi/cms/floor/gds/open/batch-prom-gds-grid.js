...
//		var siteId = $("#siteId").val();
		...
		$("#gds_grid_dataGridTable").initDT({
	        ...
	        "aoColumns": [
				...
				{ "mData": "status", "sTitle":"商品状态","sWidth":"100px","bSortable":false,"mRender": function(data,type,row){
					if(data=='0'){
						return "待上架";
					}else if(data=='11'){
						return "已上架";
				...
				{ "mData": "parentId", "sTitle":"促销编码","sWidth":"100px","bVisible":false,"bSortable":false},
				{ "mData": "promTheme", "sTitle":"促销名称","sWidth":"100px","bSortable":false,"mRender": function(data,type,row){
					return SearchObj.HTMLEncode(data);
				}},
				{ "mData": "promTypeCode", "sTitle":"促销类别代码","sWidth":"100px","bVisible":false,"sWidth":"100px","bSortable":false},
