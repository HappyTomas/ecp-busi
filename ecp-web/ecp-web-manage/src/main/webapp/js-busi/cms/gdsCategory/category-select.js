$(function(){
    ...
    var constants = {
    	TREE_NODE_URL_NORMAL : GLOBAL.WEBROOT+"/cms/category/asyncData/selector/getNodes?siteId="+$('#siteId').val(),     // 分类树正常获取节点URL地址.
    	TREE_NODE_URL_SEARCH : GLOBAL.WEBROOT+"/cms/category/asyncData/selector/catgsearch?siteId="+$('#siteId').val()	 // 分类树搜索功能获取节点URL地址.
    };
