        ...
        eDialog.confirm("导出销售情况" , {
            buttons: [{
                ...
                'callback': function () {
                    ...
                    // window.open(GLOBAL.WEBROOT+'/ordExport/exportPage?exportInfo='+JSON.stringify(p),"newwindow", "top=100,height=100, width=400, toolbar =no, menubar=no, scrollbars=no, resizable=no, location=no, status=no");
