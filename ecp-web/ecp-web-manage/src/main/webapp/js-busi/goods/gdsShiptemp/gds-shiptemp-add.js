...
$(function() {
	...
	$("#saveGdsInfo").click(function(){
		if(!($("#addShiptempForm").valid() && ShipAdd.validDefaultFree() && ShipAdd.validSeniorFree()))return;
...
var ShipAdd = {
		newTemplate : function(){
			...
			"<td><input type='text' onblur=\"validatorSenior(this,'price')\" id='free"+_c+"' name='free' class='input-mini '></td>"+
	        "<td><input type='text' onblur=\"validatorSenior(this,'number')\" id='first"+_c+"' name='first' class='input-mini '></td>"+
	        "<td><input type='text' onblur=\"validatorSenior(this,'number')\" id='second"+_c+"' name='second' class='input-mini '></td>"+
	        "<td><input type='text' onblur=\"validatorSenior(this,'price')\" id='secondFree"+_c+"' name='secondFree' class='input-mini '></td>"+
	        "<td><input type='text' onblur=\"validatorSenior(this,'number')\" id='noFree"+_c+"' name='noFree' class='input-mini '></td>"+
		...
		saveShiptemp : function(obj){
			...
			$.eAjax({
				url : GLOBAL.WEBROOT + "/gdsshiptemp/addshiptemp",
				data : param,
