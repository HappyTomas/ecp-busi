...
//				},
				...
				{ "mData": "gdsStatus","sTitle":"操作","sWidth":"80px","sClass": "center",
					"mRender": function(data,type,row){
						...
						if(row.shopStatus=='0'){
							if(data == '0'){
								//return "<a href='javascript:void(0)' "+validShop+">上架</a> | <a href='javascript:void(0)' "+validShop+" >编辑</a> | <a href='javascript:void(0)' "+validShop+" >删除</a>| <a href='javascript:void(0)' "+validShop+" onclick=\"gdsDetail('"+row.id+"')\">详情</a>";
								return "<a href='javascript:void(0)' "+validShop+" onclick=\"gdsDetail('"+row.id+"')\">详情</a>";
							}else if(data == '11'){
								//return "<a href='javascript:void(0)' "+validShop+">下架</a>| <a href='javascript:void(0)' "+validShop+" onclick=\"gdsDetail('"+row.id+"')\">详情</a>";
								return "-";
							}else if(data == '22'){
								//return "<a href='javascript:void(0)' "+validShop+">上架</a> | <a href='javascript:void(0)' "+validShop+" >编辑</a> | <a href='javascript:void(0)' "+validShop+" >删除</a>| <a href='javascript:void(0)' "+validShop+" onclick=\"gdsDetail('"+row.id+"')\">详情</a>";
								return "<a href='javascript:void(0)' "+validShop+" onclick=\"gdsDetail('"+row.id+"')\">详情</a>";
		...
		arr = new Array(
				...
				{ "mData": "mainCatgName", "sTitle":"主分类名称","sWidth":"80px","sClass": "center","bSortable":false},
				{ "mData": "isbn", "sTitle":"商品编号","sWidth":"80px","sClass": "center","bSortable":false},
				{ "mData": "guidePrice", "sTitle":"商品指导价","sWidth":"80px","sClass": "center","bSortable":false,
					"mRender": function(data,type,row){
						var str = (data/100).toFixed(2) + '';
						var intSum = str.substring(0,str.indexOf("."));//取到整数部分.replace( /\B(?=(?:\d{3})+$)/g, ',' )
				...
				{ "mData": "shipTemplateName", "sTitle":"运费模板","sWidth":"80px","sClass": "center","bSortable":false,
					...
					"mRender": function(data,type,row){
						if(row.gdsStatus=='99'||row.gdsStatus=='11'){
							...
							if(row.shipTemplateId== -1 || row.shipTemplateId == 0||data==null){
								return "<a href='javascript:void(0)' onclick=\"setGdsShiptemp(this,'"+row.id+"','"+row.shopId+"','"+row.mainCatgs+"')\">设置运费模板</a>";
							}else{
								return data+"</br><a href='javascript:void(0)' onclick=\"cancelGdsShiptemp(this,'"+row.id+"','"+row.shopId+"')\">取消运费模板</a>";
							}
						}
