$(function(){
	...
	var _maxShowNodes = $("#maxShowNode").val();
    ...
    var constants = {
    	TREE_NODE_URL_NORMAL : GLOBAL.WEBROOT+"/goods/category/asyncData/selector/getNodes?" + "maxShowNode=" + _maxShowNodes,     // 分类树正常获取节点URL地址.
