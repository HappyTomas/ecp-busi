$(function(){
	...
	$("#btn_group_save").click(function(){
		...
		$.eAjax({
	        url: GLOBAL.WEBROOT + '/phrasebook/group/save',
	        data: data,
	        datatype: 'json',
	...
	$("#btn_item_save").click(function(){
		...
		data.push(groupId);
		$.eAjax({
	        url: GLOBAL.WEBROOT + '/phrasebook/item/save',
	        data: data,
	        datatype: 'json',
	        success: function(returnInfo) {
	        	if(id){
	...
	$("#btn_del").click(function(){
		...
		var url = GLOBAL.WEBROOT + '/phrasebook/item/del';
		if(_hasChildren(selectedNode)){//拥有子节点，为分组
			url = GLOBAL.WEBROOT + '/phrasebook/group/del';
		}
	...
	function createZtree(){
		...
		$.ajax({
	        url: GLOBAL.WEBROOT + '/phrasebook/tree',
