$(function(){
	$("#dataGridTable").initDT({
        ...
        "sAjaxSource": GLOBAL.WEBROOT + '/custservice/third/gridlist',
        "params":[{}],
        //指定列数据位置
        "aoColumns": [
			{ "mData": "staffCode", "sTitle":"会员名","sWidth":"50px","bSortable":true},
			{ "mData": "shopName", "sTitle":"所属平台","sWidth":"50px","bSortable":false},
	...
	$('#btn_code_add').click(function(){
		window.location.href = GLOBAL.WEBROOT+'/custservice/third/add';
	});
